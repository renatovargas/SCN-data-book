...
Let's start to get acquainted with R commands. Most of what you will do in R is create a data object and then use functions to manipulate or change that object. Most functions operating on an object in R look like this:
...
We can get fancy and sample out of a bag of things, like letters from the English alphabet, by assigning them as vectors in an object, and then use the sample function to take out a desired number of elements from it, with or without replacement.  
